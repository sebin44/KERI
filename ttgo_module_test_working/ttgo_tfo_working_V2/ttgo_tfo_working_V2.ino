...
const char resource[] = "http://api.thingspeak.com/update?api_key=916MDKEGM0W9C8NV";
const int  port = 80;
...
String apiKeyValue = "916MDKEGM0W9C8NV";
String myReadAPIKey = "KW4H5JZUQ5YO8AXX";
...
void loop()
{
  ...
  if (Serial.available()>=32) {
    ...
    String httpRequestData = "api_key=" + apiKeyValue + "&field1=" + String(TOF_distance)+ "";
